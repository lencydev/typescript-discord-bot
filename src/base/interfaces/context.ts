...
export default class Context {
  ...
  constructor(client?: Client, interaction?: CommandInteraction) {
    ...
    this.menu = {
      ...
      eval ({ ephemeral = true, fastSkip = false, value, result, embed }: { ephemeral?: boolean, fastSkip?: boolean, value: number, result: any, embed: MessageEmbed }) {
          ...
          if (!ephemeral) {
            ...
            if (page == pages) {
              ...
              checkPages = ctx.interaction.reply({
                ...
                embeds: [
                  embed.setFields([
                    { name: `Type`, value: `${ctx.case.title(typeof(result))}`, inline: false },
            ...
            checkPages.then(async () => {
              ...
              collector.on('collect', async (button: any) => {
                ...
                if (button.customId == 'delete') {
                  ...
                  firstIndex = 1000 * pages -1000;
                  lastIndex = 1000 * pages;
